...
export const ProjectData = [
    {
        ...
        onButtonClick: () => alert('no link avaialable'),
    },
    {
        id: 2,
        icon: FaMobileAlt,
    ...
    },
    {
    ...
    },
     {
        ...
        icon: FaGlobe,
        title: "Drink Mood",
        description: "Built a responsive, modern, and attractive UI application using React.js, Tailwind CSS, GSAP animations, and TypeScript. This project features a 3D animated drink model with smooth transitions and interactive elements, showcasing advanced GSAP animation techniques. The application is fully responsive, ensuring compatibility across all devices and screen sizes.",
        buttonText: "View Project",
        technologies: ["React.js", "Tailwind CSS", "GSAP", "TypeScript"],
        onButtonClick: () => window.open("https://dipanjan441.github.io/Drink-mood", "_blank"),
    },
    {
        id: 6,
        icon: FaGlobe,
